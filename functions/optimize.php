...
/* HTML SOURCE COMPRESSION / MINIFY */
...
function add_defer_attribute($tag, $handle) {
   ...
   $scripts_to_defer = array('aos-css','fancybox-css','fontawesome-5-css', 'swiper-css','swiper-js','aos-js','custom-script');
